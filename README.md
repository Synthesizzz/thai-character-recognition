...
ชุดทดสอบเพิ่มเติมที่ใช้วัด (`datasets for testing/synthetic_test_set`, ไม่อยู่ใน repo): 432 ภาพ 72 คลาส สร้างจากฟอนต์ดิจิทัล
เป็นคนละ domain กับชุดเทรน (ชุดเทรนน่าจะครอปมาจากแบบฟอร์มลายมือ/สแกน — สันนิษฐานจากชื่อไฟล์ ไม่มีเอกสารยืนยัน)
