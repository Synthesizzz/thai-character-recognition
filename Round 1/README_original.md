# ⚠️ Archive — เวอร์ชันแรก ไม่ใช้ส่งแล้ว

ถูกแทนที่ด้วย [`../Round 2/`](<../Round 2>) แล้ว (val_acc 98.48% → 98.79%, synthetic test 53.70% → 68.75%)
เก็บโฟลเดอร์นี้ไว้แค่เป็นหลักฐาน/เทียบผลย้อนหลังเท่านั้น
