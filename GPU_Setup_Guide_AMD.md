...
บันทึกขั้นตอนที่ทำจริงตอนย้ายจาก Colab มารันเทรนบนเครื่อง local เพราะ Colab หมด GPU quota
ใช้ได้กับโปรเจกต์อื่นที่ใช้ PyTorch บนเครื่องนี้ด้วย ไม่ได้จำกัดแค่โปรเจกต์นี้
