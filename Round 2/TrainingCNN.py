"""
เวอร์ชัน local ของโน้ตบุ๊กที่รันบน Colab (round 2 — ปรับปรุงจาก Round 1/) — ตัดส่วนที่ผูกกับ Colab ออก
...
เปลี่ยนจาก Round 1/ (รอบแรก) (val_acc 98.48%):
...
for cls in tqdm(classes, desc="Loading images"):
    ...
    for fname in img_files:
        ...
        # เช็ค max ก่อนหารกันหารซ้ำสอง (ถ้าหารซ้ำค่าจะพังเหลือใกล้ 0 ทุกพิกเซล — เจอบั๊กนี้จริงตอนทดสอบกับภาพ RGB)
        if img.max() > 1.0:
            img /= 255.0
